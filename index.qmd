...
Slides: [Slides](slides.html){target="_blank"} ( Go to `slides.qmd`
to edit)

Journal Summaries: [Summaries](summaries.html){target="_blank"}

Literature Review: [Literature Review](litReview.html){target="_blank"}
...
# List of qmd files to render
files <- c("slides.qmd", "summaries.qmd", "litReview.qmd")
